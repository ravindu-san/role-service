...
public class PermissionServiceTest {
    ...
    @Test
    void testFindAll() {
        PermissionEntity permissionEntity1 = PermissionEntity.builder().id("123abc").name("read permission").build();
        PermissionEntity permissionEntity2 = PermissionEntity.builder().id("789xyz").name("write permission").build();
