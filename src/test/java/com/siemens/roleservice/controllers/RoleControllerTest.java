...
public class RoleControllerTest {
  ...
  public void testGetRolesReturnsHttpStatus200() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get("/roles").contentType(MediaType.APPLICATION_JSON))
  ...
  public void testGetRolesReturnsListOfRoles() throws Exception {
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].id").value("9faaf9ba-464e-4c68-a901-630fc4de123b"))
  ...
  public void testSetPermissionsForRoleReturnsHttpStatus200() throws Exception {
    ...
    PermissionEntity permissionEntity =
        PermissionEntity.builder().id(permissionId).name("View").build();
